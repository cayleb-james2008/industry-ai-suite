...
| SearchLift | One fresh fixed read of `https://cayleb-james2008.github.io/agentic-resume/` returned HTTP 200 at `2026-09-25T17:52:01Z`; source `Last-Modified` `2026-09-25T14:50:52Z`, ID `cayleb-james2008.github.io:/agentic-resume/`, response SHA-256 `b4ed4de9f785a5059acde72c7660d6c20351d8409915c6323a252836b3001c88`. Bounded projection result: **PASS, 10/10** distinct approved names; the 20-heading and 30-paragraph caps were reached, with each captured item limited to 1,000 characters. The result covers only returned fields; omitted/truncated text and other routes were not assessed. The measured receipt is `session-artifacts/searchlift-current-pages-20260925/pieces/P2/P2-live-observation.md`; the P1 observation and former Vercel capture remain historical records only. | Terms reference: [GitHub MIT license metadata](https://api.github.com/licenses/mit) for the owned `agentic-resume` repository. | Unseen page content or other routes, analytics, traffic, search rankings, search performance, AI completion, or business outcomes.
